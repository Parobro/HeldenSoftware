...
extends Druide {
    ...
    public int getMinimalEigenschaftswert(b_0 b_02) {
        ...
        if (b_02.equals(b_0.\u00f5\u00f5\u00d2000)) {
            return 3 + super.getMinimalEigenschaftswert(b_0.\u00f5\u00f5\u00d2000);
        }
    ...
    public k_0<oo0o_0> getTalentwerte(voidsuper voidsuper2, voidsuper voidsuper3, int n) {
        ...
        k_02.\u00d200000(this.getZauber(Zauber.\u00d5\u00d8\u00d3000), 1);
        k_02.\u00d200000(this.getZauber(Zauber.\u00f4\u00d5\u00d4000), 2);
        k_02.\u00d200000(this.getZauber(Zauber.\u00d3O\u00d5000), 2);
        ...
        k_02.\u00d200000(this.getZauber(Zauber.thisintnew), 2);
    ...
    public ArrayList<for> getVerbilligteSonderfertigkeiten() {
        ...
        arrayList.add(new for(while.\u00d2\u00d4O000.toString()));
        return arrayList;
    }
