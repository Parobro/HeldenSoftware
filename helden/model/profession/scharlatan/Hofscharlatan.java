...
extends VarianteScharlatan {
    ...
    public String getBezeichner(Geschlecht geschlecht) {
        if (geschlecht.istMaennlich()) {
            return "Hofscharlatan";
        }
        return "Hofscharlatanin";
    }
    ...
    public K getRepraesentation(Zauber zauber) {
        if (zauber.equals(Zauber.Stringpublicnew)) {
            return K.\u00f8O0000;
        }
        return K.\u00d300000;
    }
    ...
    public k_0<oo0o_0> getTalentwerte(voidsuper voidsuper2, voidsuper voidsuper3, int n) {
        ...
        k_02.o00000(this.getZauber(Zauber.whilenullnew), 6);
        k_02.o00000(this.getZauber(Zauber.\u00f5\u00d5\u00d3000), 5);
        k_02.o00000(this.getZauber(Zauber.fordonew), 6);
        ...
        k_02.o00000(this.getZauber(Zauber.privatefloatnew), 4);
