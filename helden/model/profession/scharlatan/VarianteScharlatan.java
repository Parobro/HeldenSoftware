...
public abstract class VarianteScharlatan
extends helden.framework.int.N {
    public VarianteScharlatan(String string, int n) {
        super(string, n);
    }
    ...
    public ArrayList<String> getBesondererBesitzMoeglichkeiten() {
        ...
        arrayList.add("Kugel mit erstem Kugelzauber");
        arrayList.add("einfaches Pferd");
        return arrayList;
    }
    ...
    public ArrayList<P> getSonderfertigkeiten() {
        ...
        arrayList.add(oooo_0.o00000(while.returnclasssuper.toString()));
    ...
    public WaehlbareZauber getWaehlbareZauber() {
        ...
        waehlbareZauber.addAll(ZauberFabrik.getInstance().mindestVerbreitung(4, K.\u00d300000, this.getSetting()));
