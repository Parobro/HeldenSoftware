...
public class ZahorischerHazaqi
extends VarianteZaubertaenzer {
    public ZahorischerHazaqi() {
        super("Zahorischer Hazaqi", 4);
    }

    public ZahorischerHazaqi(String string, int n) {
        super(string, n + 4);
    }
    ...
    public String getBezeichner(Geschlecht geschlecht) {
        if (geschlecht.istMaennlich()) {
            return "Zahorischer Hazaqi";
        }
        return "Zahorische Hazaqi";
    }
