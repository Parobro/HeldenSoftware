...
public class BasisKavallerie
extends N {
    public BasisKavallerie() {
        this("Gareth oder Arivor", 11);
    }

    public BasisKavallerie(String string, int n) {
        super(string, n);
    }
    ...
    public k_0<oo0o_0> getTalentwerte(voidsuper voidsuper2, voidsuper voidsuper3, int n) {
        ...
        k_02.o00000(voidsuper.nullvoidObject, 6);
    ...
    public Oo0O getVorteile() {
        ...
        j2.oO0000(10);
        oo0O.\u00d300000(j2);
        oo0O.\u00d300000(K.o00000(I.whilenewsuper, 2000));
        return oo0O;
    }

    @Override
    public String toString() {
        return "Gareth oder Arivor";
    }
}
