...
extends Schwertgeselle {
    ...
    public ArrayList<for> getVerbilligteSonderfertigkeiten() {
        ...
        arrayList.add(for.o00000(E.\u00d4\u00d5\u00d8000, arrayList2, 1));
        return arrayList;
    }

    @Override
    public o00o_0 getVorteilAuswahl(int n) {
        ArrayList<public> arrayList = new ArrayList<public>(3);
        J j2 = (J)K.o00000(I.\u00d50o000);
        j2.oO0000(5);
        arrayList.add(j2);
        J j3 = (J)K.o00000(I.privateint);
        j3.oO0000(5);
        arrayList.add(j3);
        J j4 = (J)K.o00000(I.privatesupersuper);
        j4.oO0000(5);
        arrayList.add(j4);
