...
extends Schwertgeselle {
    ...
    public String getBezeichner(Geschlecht geschlecht) {
        return "Balayan nach Marwan Sahib";
    }
    ...
    public k_0<oo0o_0> getTalentwerte(voidsuper voidsuper2, voidsuper voidsuper3, int n) {
        ...
        k_02.\u00d200000(E.nullsuperString, 5);
    ...
    public ArrayList<for> getVerbilligteSonderfertigkeiten() {
        ...
        arrayList2.add(E.\u00d5\u00d6\u00d8000.toString());
        arrayList.add(new for(arrayList2, while.\u00f6\u00d5\u00d2000, false));
    ...
    public Oo0O getVorteile() {
        ...
        oo0O.new(K.o00000(I.whilenewsuper));
        B b = (B)K.o00000(I.O\u00d5o000);
        b.o00000("Echsen", (Integer)7);
        oo0O.\u00d300000(b);
        oo0O.\u00d300000(K.o00000(I.\u00d3\u00d30000, "Marwan Sahib"));
        return oo0O;
    }
}
