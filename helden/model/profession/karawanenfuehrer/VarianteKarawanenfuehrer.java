 ...
 */
package helden.model.profession.karawanenfuehrer;
...
public class VarianteKarawanenfuehrer
extends N {
    public VarianteKarawanenfuehrer() {
        super("Karawanenf\u00fchrer", 5);
    }

    public VarianteKarawanenfuehrer(String string, int n) {
        super(string, 5 + n);
    }
    ...
    public ArrayList<String> getBesondererBesitzMoeglichkeiten() {
        ...
        arrayList.add("Erfahrenes Lasttier");
        return arrayList;
    }
    ...
    public String getBezeichner(Geschlecht geschlecht) {
        if (geschlecht.istMaennlich()) {
            return "Karawanenf\u00fchrer";
        }
        return "Karawanenf\u00fchrerin";
    }
    ...
    public ArrayList<P> getSonderfertigkeiten() {
        ...
        arrayList.add(oooo_0.o00000(while.\u00d30\u00d2000, "Reisestrecke"));
        return arrayList;
    }
    ...
    public Oo0O getVorteile() {
        ...
        oo0O.\u00d300000(K.o00000(I.\u00f8\u00d4O000, "bevorzugtes Reisegebiet"));
        return oo0O;
    }
