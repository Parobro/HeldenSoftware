...
public class VerschwiegeneSchwester
extends BasisHexe {
    public VerschwiegeneSchwester() {
        super("Verschwiegene Schwester", 19);
    }
    ...
    public ArrayList<String> getBesondererBesitzMoeglichkeiten() {
        ...
        arrayList.add("Kr\u00e4uter f\u00fcr 70D");
        arrayList.add("Gifte f\u00fcr 70D");
        return arrayList;
    }
    ...
    public String getBezeichner(Geschlecht geschlecht) {
        if (geschlecht.istMaennlich()) {
            return "Verschwiegene Schwestern";
        }
        return "Verschwiegene Schwester";
    }
    ...
    public k_0<oo0o_0> getTalentwerte(voidsuper voidsuper2, voidsuper voidsuper3, int n) {
        ...
        k_02.\u00d200000(this.getZauber(Zauber.\u00d3O\u00d3000), 7);
        ...
        k_02.\u00d200000(this.getZauber(Zauber.O\u00d3\u00d5000), 7);
        k_02.\u00d200000(this.getZauber(Zauber.\u00d3\u00d2\u00d4000), 7);
        k_02.\u00d200000(this.getZauber(Zauber.\u00d4\u00f8\u00d3000), 3);
        k_02.\u00d200000(this.getZauber(Zauber.\u00f8\u00f8\u00d2000), 2);
        k_02.\u00d200000(this.getZauber(Zauber.\u00f5\u00f4\u00d3000), 4);
        k_02.\u00d200000(this.getZauber(Zauber.\u00f4\u00d2\u00d3000), 2);
        k_02.\u00d200000(this.getZauber(Zauber.StringObjectnew), 3);
    ...
    public ArrayList<for> getVerbilligteSonderfertigkeiten() {
        ...
        arrayList.remove(new for(while.o\u00f6\u00f6000));
        return arrayList;
    }
    ...
    public WaehlbareZauber getWaehlbareZauber() {
        ...
        waehlbareZauber.add(KonkreterZauber.getZauber(Zauber.\u00d5\u00f6\u00d3000, K.if, ""));
        ...
        waehlbareZauber.remove(KonkreterZauber.getZauber(Zauber.\u00d5\u00f5\u00d4000, K.if, ""));
        waehlbareZauber.remove(KonkreterZauber.getZauber(Zauber.ifnewnew, K.if, ""));
