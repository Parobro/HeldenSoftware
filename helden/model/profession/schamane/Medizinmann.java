...
public abstract class Medizinmann
extends N {
    public Medizinmann(String string, int n) {
        super(string, n);
    }
    ...
    public ArrayList<P> getSonderfertigkeiten() {
        ...
        arrayList.add(oooo_0.o00000(while.newfloatclass.toString()));
        arrayList.add(oooo_0.o00000(while.\u00f6\u00d80000.toString()));
        arrayList.add(oooo_0.o00000(while.\u00f5o\u00d2000.toString()));
        arrayList.add(oooo_0.o00000(while.privatenewObject.toString()));
        return arrayList;
    }
    ...
    public ArrayList<for> getVerbilligteSonderfertigkeiten() {
        ...
        arrayList.add(new for(while.\u00d8\u00f8\u00d6000));
        return arrayList;
    }
    ...
    public Oo0O getVorteile() {
        ...
        m2.o00000("Wind");
        oo0O.\u00d300000(m2);
        oo0O.\u00d300000(K.o00000(I.whileStringsuper));
        return oo0O;
    }
