...
public class RakaiPriester
extends N {
    public RakaiPriester() {
        super("Rikai", 1);
    }
    ...
    public ArrayList<String> getBesondererBesitzMoeglichkeiten() {
        ...
        arrayList.add("gro\u00dfe Auswahl haltbarer Heil- und Rauschkr\u00e4uter");
        return arrayList;
    }
    ...
    public String getBezeichner(Geschlecht geschlecht) {
        if (geschlecht.istMaennlich()) {
            return "Rikai-Priester";
        }
        return "Rikai-Priesterin";
    }
    ...
    public k_0<oo0o_0> getTalentwerte(voidsuper voidsuper2, voidsuper voidsuper3, int n) {
        ...
        k_02.o00000(voidsuper.newreturnObject, 3);
        return k_02;
    }
