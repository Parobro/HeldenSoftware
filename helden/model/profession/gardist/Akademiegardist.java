...
public class Akademiegardist
extends Gardist {
    public Akademiegardist() {
        super("Akademiegardist", 8);
    }

    public Akademiegardist(String string, int n) {
        super("name", n + 8);
    }
    ...
    public String getBezeichner(Geschlecht geschlecht) {
        if (geschlecht.istMaennlich()) {
            return "Akademiegardist/Tempelgardist/Ehrengardist";
        }
        return "Akademiegardistin/Tempelgardistin/Ehrengardistin";
    }
    ...
    public Oo0O getVorteile() {
        ...
        J j2 = (J)K.o00000(I.\u00d5oo000, "Loyalit\u00e4t gegen\u00fcber dem Arbeitgeber");
        j2.oO0000(6);
        oo0O.\u00d300000(j2);
        return oo0O;
    }
