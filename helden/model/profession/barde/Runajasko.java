...
public class Runajasko
extends Barde {
    public Runajasko() {
        super("Skalde aus Runajasko", 14);
    }
    ...
    public String getBezeichner(Geschlecht geschlecht) {
        if (geschlecht.istMaennlich()) {
            return "Skalde aus der Runajasko (UdW)";
        }
        return "Skaldin aus der Runajasko (UdW)";
    }
    ...
    public ArrayList<P> getSonderfertigkeiten() {
        ...
        arrayList.add(K.o00000(voidsuper.newnewObject, "Balladenvortrag"));
        return arrayList;
    }
