...
extends N {
    protected voidsuper \u00d40\u00f5O00;
    protected voidsuper \u00d50\u00f5O00;
    ...
    public returnsuper getNextTaPVerteilAuswahl(int n) {
        ...
        switch (n) {
            case 0: {
                ...
                arrayList.remove(this.\u00d40\u00f5O00);
                arrayList.remove(this.\u00d50\u00f5O00);
                return new returnsuper(this.getProfession(), arrayList, 4, 4);
            }
        }
        throw new c_1();
    }
