...
public class TradSchiffbauer
extends N {
    public TradSchiffbauer() {
        super("traditioneller Schiffbauer", 11);
    }
    ...
    public ArrayList<String> getBesondererBesitzMoeglichkeiten() {
        ...
        arrayList.add("Jolle");
        arrayList.add("Werkzeugkoffer mit spezialisiertem hochwertigem Werkzeug");
        return arrayList;
    }
    ...
    public String getBezeichner(Geschlecht geschlecht) {
        if (geschlecht.istMaennlich()) {
            return "traditioneller Schiffbauer (UdW)";
        }
        return "traditionelle Schiffbauerin (UdW)";
    }
    ...
    public returnsuper getNextTaPVerteilAuswahl(int n) {
        ...
        switch (n) {
            case 0: {
                ...
                return new returnsuper(this.getProfession(), arrayList, 7, 7);
            }
        }
    ...
    public ArrayList<P> getSonderfertigkeiten() {
        ...
        arrayList.add(K.o00000(voidsuper.o\u00d5\u00d6000, "Wald"));
        arrayList.add(K.o00000(voidsuper.\u00d3o\u00d8000, "Otta, Knorr und Snekkar"));
        return arrayList;
    }
    ...
    public k_0<oo0o_0> getTalentwerte(voidsuper voidsuper2, voidsuper voidsuper3, int n) {
        ...
        k_02.\u00d200000(voidsuper.o\u00d5\u00d6000, 7);
