...
extends I {
    ...
    public Travia(String string, int n) {
        super(string, n);
    }
    ...
    public Vector<voidsuper> getMirakelminustalente() {
        ...
        vector.addAll(N.floatsuper().\u00d2o0000());
    ...
    public ArrayList<P> getSonderfertigkeiten() {
        ...
        arrayList.add(oooo_0.o00000(while.\u00d3\u00d4\u00d5000.toString()));
        arrayList.add(oooo_0.o00000(while.\u00f6\u00f6\u00d8000.toString()));
        arrayList.add(oooo_0.o00000(while.\u00d3\u00d8\u00d4000.toString()));
        arrayList.add(oooo_0.o00000(while.\u00d20\u00f4000.toString()));
        return arrayList;
    }
    ...
    public k_0<oo0o_0> getTalentwerte(voidsuper voidsuper2, voidsuper voidsuper3, int n) {
        ...
        k_02.o00000(voidsuper.\u00d40\u00d6000, 5);
        ...
        k_02.o00000(voidsuper.StringclassObject, 7);
        ...
        k_02.o00000(voidsuper.privatedoObject, 4);
        ...
        k_02.o00000(voidsuper.o\u00f6\u00d6000, 6);
        k_02.o00000(voidsuper.returnifObject, 3);
        k_02.o00000(voidsuper.\u00f5\u00d5\u00d6000, 2);
        k_02.o00000(voidsuper.\u00d8\u00f6\u00d5000, 2);
        return k_02;
    }
    ...
    public Oo0O getVorteile() {
        ...
        oo0O.\u00d300000(K.o00000(helden.framework.C.I.\u00f8\u00d3o000.toString(), new Object[]{"Travia"}));
