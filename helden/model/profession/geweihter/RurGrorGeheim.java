...
import helden.model.profession.geweihter.RurGror;

public class RurGrorGeheim
extends RurGror {
    public RurGrorGeheim() {
        this("RurGrorGeheim", 5);
    }

    public RurGrorGeheim(String string, int n) {
        super(string, n);
    }
    ...
    public String getBezeichner(Geschlecht geschlecht) {
        if (geschlecht.istMaennlich()) {
            return "Geheimer Priester von Rur und Gror";
        }
        return "Geheime Priesterin von Rur und Gror";
    }
