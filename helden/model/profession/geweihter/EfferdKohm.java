...
public class EfferdKohm
extends Efferd {
    public EfferdKohm() {
        super("Efferd, Khom", 11);
    }
    ...
    public ArrayList<P> getSonderfertigkeiten() {
        ...
        arrayList.add(oooo_0.o00000(while.returndoclass.toString()));
        return arrayList;
    }
    ...
    public ArrayList<for> getVerbilligteSonderfertigkeiten() {
        ...
        arrayList.add(new for(while.o\u00d2\u00f5000));
        return arrayList;
    }

    @Override
    public String toString() {
        return "Efferd, Noviziat am Rand der Khom";
    }
}
