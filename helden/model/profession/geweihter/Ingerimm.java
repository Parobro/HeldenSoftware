...
public abstract class Ingerimm
extends I
implements private_0 {
    private int O\u00d5\u00f5O00 = 0;
    private Vector<voidsuper> o\u00d5\u00f5O00;

    public Ingerimm(String string, int n) {
        super(string, n);
    }
    ...
    public Vector<voidsuper> getMirakelplustalente() {
        ...
        vector.add(voidsuper.forObjectObject);
    ...
    public ArrayList<P> getSonderfertigkeiten() {
        ...
        arrayList.add(oooo_0.o00000(while.\u00d3O\u00d4000.toString()));
    ...
    public k_0<oo0o_0> getTalentwerte(voidsuper voidsuper2, voidsuper voidsuper3, int n) {
        ...
        k_02.o00000(voidsuper.ifreturnObject, 3);
        return k_02;
    }
    ...
    public ArrayList<helden.framework.C.I> getUngeeigneteVorteile() {
        ...
        arrayList.add(helden.framework.C.I.forsuper);
    ...
    public Oo0O getVorteile() {
        ...
        oo0O.\u00d300000(K.o00000(helden.framework.C.I.\u00f8\u00d3o000.toString(), new Object[]{"Ingerimm"}));
