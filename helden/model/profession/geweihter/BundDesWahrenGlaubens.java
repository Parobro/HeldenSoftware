...
public class BundDesWahrenGlaubens
extends N {
    private voidsuper \u00f8\u00f8\u00f4O00;

    public BundDesWahrenGlaubens() {
        super("Prediger vom Bund des wahren Glaubens", 10);
    }
    ...
    public ArrayList<String> getBesondererBesitzMoeglichkeiten() {
        ...
        arrayList.add("erfahrenes Reitpferd mit Sattel und Zaumzeug");
        return arrayList;
    }
    ...
    public String getBezeichner(Geschlecht geschlecht) {
        if (geschlecht.istMaennlich()) {
            return "Prediger vom Bund des wahren Glaubens";
        }
        return "Predigerin vom Bund des wahren Glaubens";
    }
    ...
    public k_0<oo0o_0> getTalentwerte(voidsuper voidsuper2, voidsuper voidsuper3, int n) {
        ...
        k_02.o00000(voidsuper.\u00d5\u00d4\u00d6000, 6);
