...
public class RurGrorWanderer
extends N {
    public RurGrorWanderer() {
        this("RurGrorWanderer", 5);
    }

    public RurGrorWanderer(String string, int n) {
        super(string, n);
    }
    ...
    public ArrayList<String> getBesondererBesitzMoeglichkeiten() {
        ...
        arrayList.add("besonders hochwertiges Werkzeug");
        return arrayList;
    }
    ...
    public String getBezeichner(Geschlecht geschlecht) {
        if (geschlecht.istMaennlich()) {
            return "Wanderpriester von Rur und Gror";
        }
        return "Wanderpriesterin von Rur und Gror";
    }
    ...
    public returnsuper getNextTaPVerteilAuswahl(int n) {
        ...
        switch (n) {
            case 0: {
                ...
                return new returnsuper(this.getProfession(), arrayList, 8, 8);
            }
        }
        throw new c_1();
    }
    ...
    public k_0<oo0o_0> getTalentwerte(voidsuper voidsuper2, voidsuper voidsuper3, int n) {
        ...
        k_02.o00000(E.returnnewString, 2);
        ...
        k_02.o00000(voidsuper.\u00d8\u00d5\u00d6000, 7);
