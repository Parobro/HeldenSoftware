...
public class Swafnir
extends I
implements private_0 {
    private int \u00d3\u00d3\u00f5O00 = 0;
    ...
    public Swafnir(String string, int n) {
        super(string, n);
    }
    ...
    public ArrayList<String> getBesondererBesitzMoeglichkeiten() {
        ...
        arrayList.add("Pers\u00f6nliche Orknase");
        return arrayList;
    }
    ...
    public s_1 getNextMirakeltalentAuswahl() {
        ...
        switch (this.\u00d3\u00d3\u00f5O00) {
            ...
            case 2: {
                ...
                arrayList.add(voidsuper.whileifObject);
    ...
    public ArrayList<P> getSonderfertigkeiten() {
        ...
        arrayList.add(oooo_0.o00000(while.\u00d6\u00f5\u00d6000.toString()));
        return arrayList;
    }
    ...
    public k_0<oo0o_0> getTalentwerte(voidsuper voidsuper2, voidsuper voidsuper3, int n) {
        ...
        k_02.o00000(voidsuper.\u00f5\u00d4\u00d5000, 3);
        return k_02;
    }
    ...
    public ArrayList<helden.framework.C.I> getUngeeigneteVorteile() {
        ...
        arrayList.add(helden.framework.C.I.privateinterface);
        arrayList.add(helden.framework.C.I.o\u00f8O000);
        arrayList.add(helden.framework.C.I.\u00f5\u00f6o000);
    ...
    public Oo0O getVorteile() {
        ...
        oo0O.\u00d300000(K.o00000(helden.framework.C.I.\u00f8\u00d3o000.toString(), new Object[]{"Swafnir"}));
        oo0O.\u00d300000(K.o00000(helden.framework.C.I.\u00d3\u00d30000));
        oo0O.\u00d300000(K.o00000(helden.framework.C.I.O\u00d5o000, "Echsenwesen", 6));
        return oo0O;
    }

    @Override
    public boolean hatMehrMirakeltalentAuswahl() {
        return this.\u00d3\u00d3\u00f5O00 < 2;
    }
