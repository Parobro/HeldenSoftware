...
implements private_0 {
    private int O0\u00f5O00 = 0;
    private Vector<voidsuper> o0\u00f5O00;

    public HSzint() {
        this("HSzint", 2);
    }

    public HSzint(String string, int n) {
        super(string, n);
    }
    ...
    public ArrayList<String> getBesondererBesitzMoeglichkeiten() {
        ...
        arrayList.add("gebundene Schlange nach Wahl");
        return arrayList;
    }
    ...
    public String getBezeichner(Geschlecht geschlecht) {
        if (geschlecht.istMaennlich()) {
            return "Priester der H'Szint";
        }
        return "Priesterin der H'Szint";
    }
    ...
    public s_1 getNextMirakeltalentAuswahl() {
        ...
        return new s_1(this, arrayList, 3);
    }
    ...
    public objectsuper_0 getSonderfertigkeitAuswahl(int n) {
        switch (n) {
            case 0: {
                ...
                arrayList.add(oooo_0.o00000(while.whiledoclass.toString()));
    ...
    public ArrayList<P> getSonderfertigkeiten() {
        ArrayList<P> arrayList = new ArrayList<P>();
        arrayList.add(oooo_0.o00000(while.\u00d20\u00d3000.toString()));
        ...
        arrayList.add(oooo_0.o00000(while.thisnewObject.toString()));
        arrayList.add(oooo_0.o00000(while.fornullObject.toString()));
    ...
    public void getVerbilligteSonderfertigkeitAuswahl(int n) {
        switch (n) {
            case 0: {
                ...
                arrayList.add(new for(while.\u00d6\u00d8\u00f6000));
    ...
    public Oo0O getVorteile() {
        ...
        oo0O.\u00d300000(K.o00000(I.\u00f8\u00d3o000.toString(), new Object[]{"H\u0092Szint"}));
