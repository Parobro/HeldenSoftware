...
implements private_0 {
    private int Stringclassfloat = 0;
    ...
    public Phex(String string, int n) {
        super(string, n);
    }
    ...
    public BedingungsVerknuepfung getNotwendigeVoraussetzungen() {
        ...
        bedingungsVerknuepfung2.addBedingung(Bedingung.hatNicht(helden.framework.C.I.\u00d4OO000, 3));
    ...
    public ArrayList<P> getSonderfertigkeiten() {
        ...
        arrayList.add(oooo_0.o00000(while.oO\u00f4000.toString()));
    ...
    public k_0<oo0o_0> getTalentwerte(voidsuper voidsuper2, voidsuper voidsuper3, int n) {
        ...
        k_02.o00000(voidsuper.O\u00f6\u00d5000, 4);
    ...
    public Oo0O getVorteile() {
        ...
        oo0O.\u00d300000(K.o00000(helden.framework.C.I.\u00f8\u00d3o000.toString(), new Object[]{"Phex"}));
    ...
    public boolean hatMehrMirakeltalentAuswahl() {
        return this.Stringclassfloat < 1;
    }
