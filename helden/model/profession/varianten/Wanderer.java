...
implements helden.framework.oOoO.A.Object {
    ...
    public m_0 getTalentAuswahl(int n) {
        ...
        switch (n) {
            case 0: {
                ...
                return new m_0(arrayList, nArray, "zur Fremdsprache passende Schrift");
            }
        }
        throw new c_1();
    }
    ...
    public ArrayList<oooo_0> getVerallgemeinteListenAuswahlen() {
        ...
        for (voidsuper voidsuper2 : N.floatsuper().super(this.getProfession().getSetting(), _1.\u00f800000)) {
            oooo_02.o00000(new b_0((Object)new interface(voidsuper2, 6, true)));
        }
        return arrayList;
    }
    ...
    public Oo0O getVorteile() {
        ...
        oo0O.\u00d300000(helden.framework.C.K.o00000(I.\u00f5\u00d80000));
        return oo0O;
    }
