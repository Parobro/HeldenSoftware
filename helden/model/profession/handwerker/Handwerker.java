...
import helden.model.kultur.Brillantzwerge;
import helden.model.kultur.Darna;
import helden.model.kultur.Dschungelstaemme;
import helden.model.kultur.Erzzwerge;
...
extends helden.framework.int.N {
    public static final int \u00f4\u00d6\u00f6000 = 1;
    public static final int \u00d4\u00d6\u00f6000 = 2;
    public static final int \u00d8\u00d6\u00f6000 = 3;
    public static final int returnifclass = 4;
    private ArrayList<m_0> \u00d5\u00d6\u00f6000;
    private boolean \u00d3\u00d6\u00f6000;
    private boolean newifclass;
    private int o\u00d6\u00f6000;
    ...
    public BedingungsVerknuepfung getWahlBedingung() {
        ...
        if (this.newifclass) {
            ...
            bedingungsVerknuepfung.addBedingung(Bedingung.hatKulturID(new Huegelzwerge().getID()));
        } else {
            switch (this.o\u00d6\u00f6000) {
                case 1: {
                    bedingungsVerknuepfung = new BedingungsVerknuepfung(VerknuepfungsArt.\u00d300000);
                    ...
                    bedingungsVerknuepfung.addBedingung(Bedingung.hatKulturID(new Miniwatu().getID()));
                ...
                case 3: {
                    ...
                    bedingungsVerknuepfung.addBedingung(Bedingung.hatKulturID(new SvellttalOkkupanten().getID()));
                    break;
                }
                case 4: {
                    bedingungsVerknuepfung = new BedingungsVerknuepfung(VerknuepfungsArt.\u00d300000);
    ...
    public void makeAuswahlen() {
        this.\u00d5\u00d6\u00f6000 = new ArrayList();
        this.\u00d5\u00d6\u00f6000.add(this.intint());
        if (this.o\u00d6\u00f6000 < 1) {
            this.\u00d5\u00d6\u00f6000.add(this.\u00d2OO000());
        }
        if (!this.newifclass) {
            if (this.o\u00d6\u00f6000 > 0) {
                this.\u00d5\u00d6\u00f6000.add(this.\u00d5OO000());
            }
            this.\u00d5\u00d6\u00f6000.add(this.\u00d6OO000());
            if (this.o\u00d6\u00f6000 != 1 || this.o\u00d6\u00f6000 != 2) {
                this.\u00d5\u00d6\u00f6000.add(this.oOO000());
            }
        }
        if (this.o\u00d6\u00f6000 == 1) {
            this.\u00d5\u00d6\u00f6000.add(this.\u00f4OO000());
        }
        if (this.o\u00d6\u00f6000 == 2) {
            this.\u00d5\u00d6\u00f6000.add(this.interfaceint());
        }
        if (this.o\u00d6\u00f6000 == 3) {
            this.\u00d5\u00d6\u00f6000.add(this.\u00d4OO000());
            this.\u00d5\u00d6\u00f6000.add(this.\u00f6OO000());
    ...
    private m_0 intint() {
        ...
        } else if (this.o\u00d6\u00f6000 == 2) {
            arrayList.add(E.\u00d3\u00d6\u00d8000);
            arrayList.add(E.\u00f5\u00d5\u00d8000);
            arrayList.add(E.\u00d5\u00d4\u00d8000);
            arrayList.add(E.\u00d3\u00d5\u00d8000);
        } else if (this.o\u00d6\u00f6000 == 4) {
            arrayList.add(E.\u00d3\u00d6\u00d8000);
            arrayList.add(E.\u00d5\u00d4\u00d8000);
            arrayList.add(E.\u00d3\u00d5\u00d8000);
        } else {
