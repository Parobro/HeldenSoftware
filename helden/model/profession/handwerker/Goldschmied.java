...
public class Goldschmied
extends HandwerklicheSpezialisierung {
    public Goldschmied() {
        super("Goldschmied/Feinschmied/Graveur");
    }

    @Override
    public String getBezeichner(Geschlecht geschlecht) {
        if (geschlecht.istMaennlich()) {
            return "Goldschmied/Feinschmied/Graveur";
        }
        return "Goldschmiedin/Feinschmiedin/Graveurin";
    }

    @Override
    public oo0o_0 getHaupttalent() {
        return voidsuper.o\u00f6\u00d5000;
    }
