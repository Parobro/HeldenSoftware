...
public class RahjaKavalier
extends N {
    public RahjaKavalier() {
        super("Rahja-Kavalier", 19);
    }
    ...
    public String getBezeichner(Geschlecht geschlecht) {
        if (geschlecht.istMaennlich()) {
            return "Kavalier Rahjas";
        }
        return "Kavaliera Rahjas";
    }
    ...
    public ArrayList<for> getVerbilligteSonderfertigkeiten() {
        ...
        arrayList.add(new for<String>("Kettenweste", while.\u00d8\u00d3\u00d2000, false));
        return arrayList;
    }
    ...
    public Oo0O getVorteile() {
        ...
        oo0O.\u00d300000(K.o00000(I.\u00d5oo000, "Loyalit\u00e4t, Ehre, Gehorsam", 8));
        oo0O.\u00d300000(K.o00000(I.\u00d3\u00d30000, "gegen\u00fcber Orden und Schutzbefohlenen"));
        return oo0O;
    }
