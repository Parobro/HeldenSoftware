...
public class Gjalskerland
extends N {
    public Gjalskerland() {
        super("Stammeskrieger der Gjalskerl\u00e4nder", 9);
    }
    ...
    public ArrayList<for> getGewaehlteVerbilligteSonderfertigkeiten() {
        ...
        arrayList2.add(new for(while.\u00d50\u00d3000));
        arrayList2.add(new for(while.\u00f6o\u00d5000));
        arrayList2.add(new for(while.\u00f5\u00d30000));
        arrayList2.add(new for(while.nullnewsuper));
        for (for for_ : arrayList2) {
            if (oOOo.\u00d200000(for_.toString())) continue;
            arrayList.add(for_);
        }
        return arrayList;
    }
    ...
    public k_0<oo0o_0> getTalentwerte(voidsuper voidsuper2, voidsuper voidsuper3, int n) {
        ...
        k_02.o00000(voidsuper.\u00f80\u00d8000, 3);
