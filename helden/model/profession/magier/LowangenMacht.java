...
public class LowangenMacht
extends StandardMagierVariante {
    public LowangenMacht() {
        super("Lowangen (Macht)", 29);
        this.oO\u00d2O00 = "schwarz";
    ...
    public BedingungsVerknuepfung getNotwendigeVoraussetzungen() {
        ...
        bedingungsVerknuepfung.addBedingung(Bedingung.hatNicht(I.nullclass));
        bedingungsVerknuepfung.addBedingung(Bedingung.hatNicht(I.OOO000));
        bedingungsVerknuepfung.addBedingung(Bedingung.hatNicht(I.\u00f5\u00d5O000));
        ...
        bedingungsVerknuepfung.addBedingung(Bedingung.hatNicht(I.newnew));
    ...
    public k_0<oo0o_0> getTalentwerte(voidsuper voidsuper2, voidsuper voidsuper3, int n) {
        ...
        k_02.o00000(this.getZauber(Zauber.o0\u00d4000), 5);
        k_02.o00000(this.getZauber(Zauber.\u00d3\u00f8\u00d3000), 6);
        ...
        k_02.o00000(this.getZauber(Zauber.\u00f4O\u00d5000), 6);
        ...
        k_02.o00000(this.getZauber(Zauber.\u00d8\u00d3\u00d4000), 5);
        k_02.o00000(this.getZauber(Zauber.\u00d3\u00d3\u00d4000), 4);
        k_02.o00000(this.getZauber(Zauber.\u00f5\u00d3\u00d4000), 4);
        k_02.o00000(this.getZauber(Zauber.\u00f80\u00d5000), 3);
        k_02.o00000(this.getZauber(Zauber.\u00d4o\u00d4000), 4);
        k_02.o00000(this.getZauber(Zauber.\u00d3o\u00d4000), 2);
        k_02.o00000(this.getZauber(Zauber.\u00d4o\u00d5000), 5);
        k_02.o00000(this.getZauber(Zauber.O\u00d3\u00d5000), 3);
        return k_02;
    }
    ...
    public ArrayList<for> getVerbilligteSonderfertigkeiten() {
        ...
        arrayList.add(new for(while.\u00d2\u00f8\u00d8000));
    ...
    public WaehlbareZauber getWaehlbareZauber() {
        ...
        waehlbareZauber.add(KonkreterZauber.getZauber(Zauber.forintnew, K.\u00f8O0000, ""));
    ...
    public String toString() {
        return "Halle der Macht zu Lowangen";
    }
}
