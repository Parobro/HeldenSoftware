...
public class Kuslik2
extends StandardMagierVariante {
    public Kuslik2() {
        super("Kuslik (Verwandlung)", 23);
        this.oO\u00d2O00 = "wei\u00df";
    ...
    public k_0<oo0o_0> getTalentwerte(voidsuper voidsuper2, voidsuper voidsuper3, int n) {
        ...
        k_02.o00000(this.getZauber(Zauber.whilereturnnew), 7);
    ...
    public Oo0O getVorteile() {
        ...
        oo0O.\u00d300000(helden.framework.C.K.o00000(I.\u00d5oo000, "", 10));
    ...
    public String toString() {
        return "Halle der Metamorphosen zu Kuslik";
    }
}
