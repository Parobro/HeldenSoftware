...
public class RivaLeibwaechter
extends Riva {
    public RivaLeibwaechter() {
        super("Magischer Leibw\u00e4chter", 25);
    }
    ...
    public k_0<oo0o_0> getTalentwerte(voidsuper voidsuper2, voidsuper voidsuper3, int n) {
        ...
        k_02.\u00d200000(this.getZauber(Zauber.\u00f8o\u00d4000), 7);
        k_02.\u00d200000(this.getZauber(Zauber.O\u00d3\u00d4000), 7);
        k_02.\u00d200000(this.getZauber(Zauber.\u00d5\u00d2\u00d3000), 7);
        k_02.\u00d200000(this.getZauber(Zauber.\u00d3\u00d3\u00d4000), 7);
        k_02.\u00d200000(this.getZauber(Zauber.o\u00d2\u00d5000), 6);
        k_02.\u00d200000(this.getZauber(Zauber.\u00f5\u00d3\u00d4000), 6);
        k_02.\u00d200000(this.getZauber(Zauber.\u00d5\u00f6\u00d4000), 2);
        k_02.\u00d200000(this.getZauber(Zauber.\u00f8\u00f8\u00d2000), 4);
        k_02.\u00d200000(this.getZauber(Zauber.\u00f8\u00d2\u00d5000), 2);
        k_02.\u00d200000(this.getZauber(Zauber.\u00f8\u00f5\u00d3000), 4);
        k_02.\u00d200000(this.getZauber(Zauber.forinterfacenew), 3);
