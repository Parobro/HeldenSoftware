...
public abstract class Riva
extends StandardMagierVariante {
    private String nulldovoid;

    public Riva(String string, int n) {
        super("Riva (" + string + ")", n);
        this.nulldovoid = string;
        this.oO\u00d2O00 = "grau";
    ...
    public ArrayList<String> getBesondererBesitzMoeglichkeiten() {
        ...
        arrayList.add("magische Lehrb\u00fccher (100D)");
        return arrayList;
    }
    ...
    public k_0<oo0o_0> getTalentwerte(voidsuper voidsuper2, voidsuper voidsuper3, int n) {
        ...
        k_02.o00000(this.getZauber(Zauber.\u00d8\u00d4\u00d3000), 2);
        k_02.o00000(this.getZauber(Zauber.Stringpublicnew), 4);
        k_02.o00000(this.getZauber(Zauber.\u00f5o\u00d3000), 2);
    ...
    public WaehlbareZauber getWaehlbareZauber() {
        ...
        for (KonkreterZauber konkreterZauber : waehlbareZauber.getZauberListe()) {
            if (!konkreterZauber.hatMerkmal(o00O.\u00d2O0000) && !konkreterZauber.hatDaemonischesMerkmal() || konkreterZauber.hatMerkmal(o00O.\u00d300000)) continue;
    ...
    public String toString() {
        return "Stoerrebrandt-Kolleg zu Riva (" + this.nulldovoid + ")";
    }
}
