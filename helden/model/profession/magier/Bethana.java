...
extends StandardMagierVariante {
    ...
    public m_0 getTalentAuswahl(int n) {
        ...
        switch (n) {
            case 0: {
                arrayList.add(this.getZauber(Zauber.Stringsupernew));
    ...
    public k_0<oo0o_0> getTalentwerte(voidsuper voidsuper2, voidsuper voidsuper3, int n) {
        ...
        k_02.\u00d200000(this.getZauber(Zauber.\u00f8\u00f8\u00d2000), 6);
        k_02.\u00d200000(this.getZauber(Zauber.\u00f8o\u00d4000), 6);
        k_02.\u00d200000(this.getZauber(Zauber.\u00d4\u00d2\u00d5000), 6);
        k_02.\u00d200000(this.getZauber(Zauber.O\u00d4\u00d3000), 5);
        k_02.\u00d200000(this.getZauber(Zauber.\u00d5\u00d2\u00d3000), 6);
        k_02.\u00d200000(this.getZauber(Zauber.\u00f5\u00d3\u00d4000), 7);
        ...
        k_02.\u00d200000(this.getZauber(Zauber.\u00d80\u00d3000), 3);
        k_02.\u00d200000(this.getZauber(Zauber.\u00d3o\u00d4000), 5);
        k_02.\u00d200000(this.getZauber(Zauber.\u00d5\u00d5\u00d3000), 4);
        k_02.\u00d200000(this.getZauber(Zauber.\u00d4\u00f4\u00d3000), 2);
        k_02.\u00d200000(this.getZauber(Zauber.\u00d4\u00d3\u00d3000), 3);
        k_02.\u00d200000(this.getZauber(Zauber.\u00d4o\u00d5000), 4);
        k_02.\u00d200000(this.getZauber(Zauber.OO\u00d4000), 2);
        return k_02;
    }
    ...
    public Oo0O getVorteile() {
        ...
        j2.oO0000(5);
        oo0O.\u00d300000(j2);
        oo0O.\u00d300000(helden.framework.C.K.o00000(I.\u00d5oo000, "Aufrichtigkeit, Wahrheitsliebe, Schutz, Treue", 10));
    ...
    public WaehlbareZauber getWaehlbareZauber() {
        ...
        waehlbareZauber.addAll(ZauberFabrik.getInstance().mindestVerbreitung(5, K.\u00f8O0000, o00O.classnew, this.getSetting()));
        waehlbareZauber.addAll(ZauberFabrik.getInstance().mindestVerbreitung(5, K.\u00f8O0000, o00O.\u00d8o0000, this.getSetting()));
    ...
    public String toString() {
        return "Halle des vollendeten Kampfes zu Bethana";
    }
}
