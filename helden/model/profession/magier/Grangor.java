...
extends StandardMagierVariante {
    ...
    public ArrayList<P> getSonderfertigkeiten() {
        ...
        arrayList.add(oooo_0.o00000(while.StringforObject.toString()));
        return arrayList;
    }
    ...
    public k_0<oo0o_0> getTalentwerte(voidsuper voidsuper2, voidsuper voidsuper3, int n) {
        ...
        k_02.o00000(this.getZauber(Zauber.nullinterfacesuper), 6);
        k_02.o00000(this.getZauber(Zauber.whilenullnew), 5);
        k_02.o00000(this.getZauber(Zauber.forpublicnew), 5);
        k_02.o00000(this.getZauber(Zauber.\u00d3\u00d3\u00d5000), 5);
        k_02.o00000(this.getZauber(Zauber.\u00d3\u00f5\u00d4000), 5);
        ...
        k_02.o00000(this.getZauber(Zauber.ifthisObject), 4);
        ...
        k_02.o00000(this.getZauber(Zauber.returnifnew), 2);
        k_02.o00000(this.getZauber(Zauber.nullsupernew), 3);
        k_02.o00000(this.getZauber(Zauber.newwhilenew), 3);
        k_02.o00000(this.getZauber(Zauber.fordonew), 4);
        k_02.o00000(this.getZauber(Zauber.\u00d5\u00d8\u00d4000), 4);
    ...
    public String toString() {
        return "Akademie der Erscheinungen zu Grangor";
    }
}
