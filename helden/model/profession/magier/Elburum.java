...
extends StandardMagierVariante {
    ...
    public ArrayList<I> getEmpfohleneVorteile() {
        ...
        arrayList.add(helden.framework.C.K.o00000(I.thisintsuper, new Object[]{"D\u00e4monen"}));
    ...
    public m_0 getTalentAuswahl(int n) {
        ...
        switch (n) {
            case 0: {
                arrayList.add(this.getZauber(Zauber.nullvoidnew));
    ...
    public k_0<oo0o_0> getTalentwerte(voidsuper voidsuper2, voidsuper voidsuper3, int n) {
        ...
        k_02.o00000(voidsuper.\u00f4\u00d5\u00d6000, 5);
        ...
        k_02.o00000(this.getZauber(Zauber.\u00d5\u00d8\u00d3000), 6);
        k_02.o00000(this.getZauber(Zauber.\u00f8o\u00d4000), 7);
        k_02.o00000(this.getZauber(Zauber.\u00f4\u00f6\u00d4000), 6);
        k_02.o00000(this.getZauber(Zauber.\u00d4\u00d2\u00d5000), 5);
        k_02.o00000(this.getZauber(Zauber.returnfornew), 7);
        ...
        k_02.o00000(this.getZauber(Zauber.O0\u00d4000), 3);
        k_02.o00000(this.getZauber(Zauber.o\u00d2\u00d5000), 3);
        k_02.o00000(this.getZauber(Zauber.O\u00d2\u00d5000), 5);
        ...
        k_02.o00000(this.getZauber(Zauber.nullsupernew), 3);
        return k_02;
    }
    ...
    public WaehlbareZauber getWaehlbareZauber() {
        ...
        waehlbareZauber.remove(KonkreterZauber.getZauber(Zauber.\u00f8o\u00d5000, K.\u00f8O0000, ""));
        waehlbareZauber.add(KonkreterZauber.getZauber(Zauber.\u00d5O\u00d3000, K.\u00f8O0000, ""));
        ...
        waehlbareZauber.add(KonkreterZauber.getZauber(Zauber.\u00f4\u00d2\u00d4000, K.\u00f8O0000, ""));
    ...
    public void setzeHauszauber(ArrayList<KonkreterZauber> arrayList) {
        ...
        arrayList.add(this.getZauber(Zauber.returnfornew));
    ...
    public String toString() {
        return "Schule der Schmerzen zu Elburum";
    }
}
