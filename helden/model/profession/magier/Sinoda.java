...
extends StandardMagierVariante {
    ...
    public k_0<oo0o_0> getTalentwerte(voidsuper voidsuper2, voidsuper voidsuper3, int n) {
        ...
        k_02.o00000(this.getZauber(Zauber.\u00f4\u00f8\u00d2000), 5);
        k_02.o00000(this.getZauber(Zauber.\u00d4\u00d6\u00d4000), 5);
        k_02.o00000(this.getZauber(Zauber.O\u00d2\u00d4000), 4);
        ...
        k_02.o00000(this.getZauber(Zauber.\u00d8\u00d3\u00d4000), 2);
        k_02.o00000(this.getZauber(Zauber.O\u00d2\u00d5000), 2);
        k_02.o00000(this.getZauber(Zauber.\u00d3o\u00d4000), 5);
        k_02.o00000(this.getZauber(Zauber.\u00d8\u00d5\u00d3000), 1);
        k_02.o00000(this.getZauber(Zauber.whilereturnnew), 4);
        k_02.o00000(this.getZauber(Zauber.O\u00d3\u00d5000), 2);
        k_02.o00000(this.getZauber(Zauber.ifthisnew), 1);
        k_02.o00000(this.getZauber(Zauber.nullsupernew), 2);
        return k_02;
    }
    ...
    public WaehlbareZauber getWaehlbareZauber() {
        ...
        waehlbareZauber.add(KonkreterZauber.getZauber(Zauber.\u00d50\u00d4000, K.\u00f8O0000, ""));
    ...
    public String toString() {
        return "Schule der vierfachen Verwandlung zu Sinoda";
    }
}
