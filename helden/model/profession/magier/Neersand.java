...
extends StandardMagierVariante {
    ...
    public k_0<oo0o_0> getTalentwerte(voidsuper voidsuper2, voidsuper voidsuper3, int n) {
        ...
        k_02.o00000(this.getZauber(Zauber.\u00f80\u00d5000), 6);
        ...
        k_02.o00000(this.getZauber(Zauber.\u00f4O\u00d4000), 2);
    ...
    public WaehlbareZauber getWaehlbareZauber() {
        ...
        for (KonkreterZauber konkreterZauber : waehlbareZauber.getZauberListe()) {
            if (!konkreterZauber.hatMerkmal(o00O.\u00d400000)) continue;
    ...
    public String toString() {
        return "Schule der Beherrschung zu Neersand";
    }
}
