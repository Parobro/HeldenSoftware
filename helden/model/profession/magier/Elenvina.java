...
extends StandardMagierVariante {
    ...
    public ArrayList<P> getSonderfertigkeiten() {
        ...
        arrayList.add(oooo_0.o00000(while.\u00d3\u00d5\u00d6000.toString()));
    ...
    public k_0<oo0o_0> getTalentwerte(voidsuper voidsuper2, voidsuper voidsuper3, int n) {
        ...
        k_02.o00000(G.\u00d3\u00d4\u00f5000, 6);
        k_02.o00000(G.\u00d8\u00d8\u00f5000, 8);
        k_02.o00000(G.\u00d5\u00d4\u00f5000, 4);
        k_02.o00000(G.\u00f4\u00d6\u00f5000, 4);
    ...
    public ArrayList<for> getVerbilligteSonderfertigkeiten() {
        ...
        arrayList.add(new for(while.\u00d3\u00d6\u00d2000));
    ...
    public Oo0O getVorteile() {
        ...
        oo0O.\u00d300000(helden.framework.C.K.o00000(I.\u00d5oo000, "Gehorsam, Disziplin, Wahrheitsliebe", 10));
    ...
    public String toString() {
        return "Akademie der Herrschaft zu Elenvina";
    }
}
