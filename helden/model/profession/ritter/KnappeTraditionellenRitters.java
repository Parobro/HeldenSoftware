...
public class KnappeTraditionellenRitters
extends RitterAltenSchlags {
    public KnappeTraditionellenRitters() {
        super("Knappe des traditionellen Ritters", -9);
    }

    public KnappeTraditionellenRitters(String string, int n) {
        super(string, n);
    }
    ...
    public String getBezeichner(Geschlecht geschlecht) {
        if (geschlecht.istMaennlich()) {
            return "Knappe des traditionellen Ritters";
        }
        return "Knappin des traditionellen Ritters";
    }
