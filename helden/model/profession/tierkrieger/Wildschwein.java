...
public class Wildschwein
extends BasisDurroDun {
    public Wildschwein() {
        super("Wildschwein", 16);
    }
    ...
    public o00o_0 getVorteilAuswahl(int n) {
        ...
        if (n == 2) {
            arrayList.add(helden.framework.C.K.o00000(I.\u00f4\u00d8O000));
            M m = (M)helden.framework.C.K.o00000(I.\u00d5\u00d50000);
            m.\u00d2o0000();
            m.o00000("pflanzliche Gifte");
            arrayList.add(m);
    ...
    public Oo0O getVorteile() {
        ...
        m2.\u00d2o0000();
        m2.o00000(b_0.returnwhilesuper);
        m2.o00000(E.\u00f4\u00d6\u00d8000);
        m2.o00000(voidsuper.\u00d4\u00f8\u00d5000);
