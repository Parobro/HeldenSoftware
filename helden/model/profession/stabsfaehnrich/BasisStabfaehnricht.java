...
public class BasisStabfaehnricht
extends N {
    public BasisStabfaehnricht(String string, int n) {
        super(string, n);
    }
    ...
    public Oo0O getVorteile() {
        ...
        oo0O.\u00d300000(K.o00000(I.\u00d5oo000, "Gehorsam, Loyalit\u00e4t, Ehrenhaftigkeit", 10));
