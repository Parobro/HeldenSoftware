...
extends OooO {
    public static final P \u00f4\u00d4\u00f8000 = new P("keine Spezialisierung", 0, false);
    public static final P \u00f5\u00d4\u00f8000 = new P("Bergst\u00e4mme", -1, false);
    public static final P privateinterfaceclass = new P("Haipu", 2, false);
    public static final P \u00d8\u00d4\u00f8000 = new P("Tschopukikuha", -1, false);
    ...
    public Oo0O getVorteile() {
        ...
        if (!this.istVariante(\u00d8\u00d4\u00f8000) && !this.istVariante(\u00f5\u00d4\u00f8000)) {
    ...
    public boolean hatMehrTalentAuswahl() {
        return this.\u00f8\u00d4\u00f8000 < 2;
    }

    @Override
    public String toString() {
        StringBuffer stringBuffer = new StringBuffer("Dschungelst\u00e4mme");
        if (this.istVariante(\u00f5\u00d4\u00f8000)) {
            stringBuffer.append("/Bergst\u00e4mme");
        }
        if (this.istVariante(privateinterfaceclass)) {
            stringBuffer.append("/Haipu");
        }
        if (this.istVariante(\u00d8\u00d4\u00f8000)) {
            stringBuffer.append("/Tschopukikuha");
        }
    ...
    protected void setzeAlleVarianten() {
        ...
        this.addAlleVarianten(privateinterfaceclass);
    ...
    protected void setzeMoeglicheVarianten() {
        ...
        this.addMoeglicheVariante(privateinterfaceclass);
