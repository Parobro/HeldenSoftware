...
public class WaldelfenSippe
extends OooO {
    private int \u00d3\u00f5\u00f6000 = 0;

    public WaldelfenSippe() {
    }

    public WaldelfenSippe(Geschlecht geschlecht) {
        super(geschlecht);
    }
    ...
    public void bestimmeTalentwerte(int n) {
        ...
        this.setTalentwert(voidsuper.\u00f8\u00f4\u00d6000, 5);
        ...
        this.setTalentwert(voidsuper.returnwhileObject, 2);
        ...
        this.setTalentwert(voidsuper.o\u00d5\u00d6000, 5);
        this.setTalentwert(voidsuper.\u00f4\u00d2\u00d6000, -2);
        this.setTalentwert(voidsuper.\u00f8\u00f4\u00d5000, 2);
        this.setTalentwert(voidsuper.\u00d4\u00f6\u00d6000, 5);
        this.setTalentwert(voidsuper.forvoidObject, 2);
        this.setTalentwert(voidsuper.\u00f4\u00d5\u00d6000, 2);
        this.setTalentwert(voidsuper.\u00d5\u00d5\u00d6000, 3);
        this.setTalentwert(voidsuper.\u00d3\u00d8\u00d5000, 5);
        this.setTalentwert(voidsuper.\u00d4\u00d4\u00d5000, 5);
        this.setTalentwert(voidsuper.privateObjectObject, 5);
    ...
    public ArrayList<super> getProfessionen(floatsuper floatsuper2) {
        ...
        kaempfer.addMoeglicheVariante(kaempfer.getWaldelfischerKaempfer());
        ...
        wildnislaeufer.addMoeglicheVariante(wildnislaeufer.getWipfellaeufer());
    ...
    public OOOo getSonderfertigkeiten() {
        ...
        oOOo.o00000(oooo_0.o00000(while.\u00d2\u00d4O000.toString()));
