 ...
 */
package helden.model.myranor.profession.sternensaenger;
...
public class SternensaengerVariante
extends N {
    public SternensaengerVariante() {
        super("Sternens\u00e4nger", "Sternens\u00e4ngerin", 11, false);
    }
    ...
    public BedingungsVerknuepfung getNotwendigeVoraussetzungen() {
        return new BedingungsVerknuepfung(VerknuepfungsArt.o00000, Bedingung.hatSfAuswahl(while.\u00d2o\u00f5000, "Kentori"));
    }

    @Override
    public ArrayList<P> getSonderfertigkeiten() {
        ArrayList<P> arrayList = super.getSonderfertigkeiten();
        arrayList.add(oooo_0.o00000(while.\u00d3\u00f8\u00d6000));
        arrayList.add(oooo_0.o00000(while.\u00d2\u00d2\u00d5000));
        return arrayList;
    }
