...
import helden.model.DDZprofessionen.tochtersatu.BasisTochter;
import java.util.ArrayList;

public class HilfreichePriesterin
extends BasisTochter {
    public HilfreichePriesterin() {
        super("HilfreichePriesterin", 21);
    }

    @Override
    public String getBezeichner(Geschlecht geschlecht) {
        if (geschlecht.istMaennlich()) {
            return "Hilfreicher Priester";
        }
        return "Hilfreiche Priesterin";
    }
    ...
    public k_0<oo0o_0> getTalentwerte(voidsuper voidsuper2, voidsuper voidsuper3, int n) {
        ...
        k_02.\u00d200000(this.getZauber(Zauber.O\u00d5\u00d3000), 6);
        k_02.\u00d200000(this.getZauber(Zauber.O\u00d2\u00d5000), 5);
        k_02.\u00d200000(this.getZauber(Zauber.whilethisObject), 4);
        k_02.\u00d200000(this.getZauber(Zauber.\u00f8\u00f8\u00d4000), 4);
        k_02.\u00d200000(this.getZauber(Zauber.\u00d4o\u00d5000), 5);
        k_02.\u00d200000(this.getZauber(Zauber.\u00d8\u00f8\u00d2000), 3);
        k_02.\u00d200000(this.getZauber(Zauber.\u00d8\u00f4\u00d4000), 3);
        k_02.\u00d200000(this.getZauber(Zauber.\u00d8\u00d6\u00d3000), 1);
        k_02.\u00d200000(this.getZauber(Zauber.\u00d5\u00d8\u00d3000), 2);
        k_02.\u00d200000(this.getZauber(Zauber.O\u00d2\u00d4000), 1);
        k_02.\u00d200000(this.getZauber(Zauber.\u00d8\u00f5\u00d3000), 2);
        k_02.\u00d200000(this.getZauber(Zauber.\u00d8\u00d3\u00d4000), 1);
