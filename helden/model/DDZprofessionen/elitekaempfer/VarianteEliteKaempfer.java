...
public class VarianteEliteKaempfer
extends N {
    public VarianteEliteKaempfer() {
        super("Elitek\u00e4mpferVariante", 0);
    }

    public VarianteEliteKaempfer(String string, int n) {
        super(string, 0 + n);
    }
    ...
    public ArrayList<P> getSonderfertigkeiten() {
        ...
        arrayList.add(oooo_0.o00000(while.\u00f50o000));
        return arrayList;
    }
