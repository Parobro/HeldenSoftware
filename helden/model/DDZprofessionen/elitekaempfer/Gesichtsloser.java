...
public class Gesichtsloser
extends VarianteEliteKaempfer {
    public Gesichtsloser() {
        super("Gesichtsloser", 21);
    }
    ...
    public ArrayList<P> getSonderfertigkeiten() {
        ...
        arrayList.add(oooo_0.o00000(while.\u00d2\u00d3\u00f6000));
        arrayList.add(oooo_0.o00000(while.o\u00f4\u00d6000));
        arrayList.add(oooo_0.o00000(while.\u00d30\u00d2000));
        arrayList.add(oooo_0.o00000(while.\u00f6\u00d20000));
        arrayList.add(oooo_0.o00000(while.\u00d30\u00d2000, "Elem"));
        return arrayList;
    }
    ...
    public ArrayList<for> getVerbilligteSonderfertigkeiten() {
        ...
        arrayList.add(new for(while.forreturnclass));
        return arrayList;
    }
