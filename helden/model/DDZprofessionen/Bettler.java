...
implements helden.framework.oOoO.A.Object {
    ...
    public void bestimmeTalentwerte(int n) {
        ...
        this.setTalentwert(voidsuper.thisinterfaceObject, 5);
        this.setTalentwert(voidsuper.forclassObject, 4);
        this.setTalentwert(voidsuper.\u00d30\u00d8000, 6);
    ...
    public OOOo getSonderfertigkeiten() {
        ...
        oOOo.o00000(K.o00000(voidsuper.\u00d30\u00d8000, "Betteln"));
        oOOo.o00000(K.o00000(voidsuper.O\u00f6\u00d5000, "Ortseinsch\u00e4tzung"));
    ...
    public ArrayList<oooo_0> getVerallgemeinteListenAuswahlen() {
        ...
        b_02.o00000(new interface(E.\u00f4\u00d6\u00d8000, 1));
        b_02.o00000(new interface(voidsuper.\u00d3\u00d8\u00d5000, 1));
        oooo_02.o00000(b_02);
        oooo_02.o00000(1);
        oooo_02.o00000(this);
