...
extends N {
    public Bauer(String string, int n) {
        super(string, n);
    }
    ...
    public objectsuper_0 getSonderfertigkeitAuswahl(int n) {
        switch (n) {
            case 0: {
                return new objectsuper_0(this.getProfession(), this.getSetting().getGelaendekunden(), 1);
            }
        }
        throw new c_1();
    }
    ...
    public ArrayList<P> getSonderfertigkeiten() {
        ...
        arrayList.add(oooo_0.o00000(while.\u00d30\u00d2000, "Ackerland/Dorf"));
        return arrayList;
    }
    ...
    public k_0<oo0o_0> getTalentwerte(voidsuper voidsuper2, voidsuper voidsuper3, int n) {
        ...
        k_02.o00000(voidsuper.\u00f8\u00d3\u00d6000, 2);
