 ...
 */
package helden.model.DDZprofessionen.taugenichts;
...
public class VarianteTaugenichts
extends N {
    public VarianteTaugenichts() {
        super("Taugenichts", 8);
    }

    public VarianteTaugenichts(String string, int n) {
        super(string, 8 + n);
    }
    ...
    public ArrayList<String> getBesondererBesitzMoeglichkeiten() {
        ...
        arrayList.add("Familienerbst\u00fcck");
        arrayList.add("mysteri\u00f6ses Artefakt");
        return arrayList;
    }
    ...
    public k_0<oo0o_0> getTalentwerte(voidsuper voidsuper2, voidsuper voidsuper3, int n) {
        ...
        k_02.o00000(G.StringdoString, 2);
