...
public abstract class VarianteDruide
extends N {
    public VarianteDruide(String string, int n) {
        super(string, n);
    }
    ...
    public objectsuper_0 getSonderfertigkeitAuswahl(int n) {
        ...
        switch (n) {
            case 0: {
                arrayList = this.getProfession().getSetting().getGelaendekunden();
