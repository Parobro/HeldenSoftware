...
public class VarianteWundarzt
extends N {
    public VarianteWundarzt() {
        super("Wundarzt", 0);
    }

    public VarianteWundarzt(String string, int n) {
        super(string, 0 + n);
    }
    ...
    public ArrayList<String> getBesondererBesitzMoeglichkeiten() {
        ...
        arrayList.add("Kr\u00e4uter und Besteck");
        return arrayList;
    }
    ...
    public k_0<oo0o_0> getTalentwerte(voidsuper voidsuper2, voidsuper voidsuper3, int n) {
        ...
        k_02.o00000(voidsuper.\u00d5\u00d5\u00d6000, 7);
