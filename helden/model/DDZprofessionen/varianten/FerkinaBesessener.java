...
extends N {
    private BedingungsVerknuepfung \u00f8o\u00f5O00 = new BedingungsVerknuepfung(VerknuepfungsArt.o00000);

    public FerkinaBesessener() {
        super("Ferkina Besessener", 3, true);
        this.\u00f8o\u00f5O00.addBedingung(Bedingung.hatKulturID(new Ferkina().getID()));
    }
