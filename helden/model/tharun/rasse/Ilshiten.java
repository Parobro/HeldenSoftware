...
public class Ilshiten
extends o0oo_0 {
    private static final int \u00f8ooO00 = 110;
    private static final int privateclassvoid = 150;
    ...
    public Ilshiten(Geschlecht geschlecht) {
        super(geschlecht);
    }
    ...
    public ArrayList<oooo_1> getAugenfarben() {
        ...
        arrayList.add(new oooo_1("hellbraun", 8, 20));
    ...
    public ArrayList<oooo_1> getHaarfarben() {
        ...
        arrayList.add(new oooo_1("braunschwarz", 4, 20));
