...
public class Lanier
extends o0oo_0 {
    private static final int O\u00d4oO00 = 110;
    private static final int \u00f8\u00d3oO00 = 155;
    private static final int Stringvoidvoid = 2;
    private static final int \u00f5\u00d3oO00 = 0;

    public Lanier() {
    }

    public Lanier(Geschlecht geschlecht) {
        super(geschlecht);
    }
    ...
    public ArrayList<oooo_1> getAugenfarben() {
        ...
        arrayList.add(new oooo_1("silbrig", 4, 20));
        arrayList.add(new oooo_1("braun", 8, 20));
        arrayList.add(new oooo_1("gr\u00fcn", 5, 20));
        arrayList.add(new oooo_1("dunkelgr\u00fcn", 3, 20));
        return arrayList;
    }
    ...
    public ArrayList<oooo_1> getHaarfarben() {
        ...
        arrayList.add(new oooo_1("rot", 6, 20));
