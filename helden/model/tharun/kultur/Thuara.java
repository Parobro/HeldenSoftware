...
extends BasisTharunKulturen {
    ...
    public Thuara(Geschlecht geschlecht) {
        super(geschlecht, "Thuara");
    }
    ...
    public void bestimmeTalentwerte(int n) {
        ...
        this.addTalentwert(N.floatsuper().\u00d200000("Gassenwissen"), 1);
    ...
    public ArrayList<I> getEmpfohleneVorteile() {
        ...
        arrayList.add(K.o00000("Vorurteile", "Ilshi Vailen"));
        return arrayList;
    }
    ...
    public ArrayList<super> getProfessionen(floatsuper floatsuper2) {
        ...
        arrayList.add(new ThuarischeNahamkiim(this.getGeschlecht(), g2, g3));
        if (floatsuper2.Object(Bedingung.hat(Geschlecht.\u00d400000))) {
            ...
            niedererGuerai.addMoeglicheVariante(niedererGuerai.getNiedererGueraiausThuara());
    ...
    public OOOo getSonderfertigkeiten() {
        ...
        oOOo.o00000(oooo_0.o00000("Kulturkunde", "Thuara"));
        return oOOo;
    }
