 ...
 */
public class DSAMetalTheme1
extends DefaultMetalTheme {
    private static final int[] if = new int[]{1, 0, 0, 1, 1, 0};
    private static final int[] \u00f400000 = new int[]{12, 12, 12, 12, 12, 10};
    ...
    private FontUIResource o00000(int n) {
        if (\u00f500000[n] == null) {
            if (\u00d300000 == null) {
                try {
                    \u00d300000 = Font.createFont(0, Thread.currentThread().getContextClassLoader().getResourceAsStream("fonts/chebi.ttf"));
                }
            ...
            DSAMetalTheme1.\u00f500000[n] = new FontUIResource(font);
        }
        return \u00f500000[n];
    }
}
