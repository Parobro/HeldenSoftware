...
public class J
extends super {
    private List<voidsuper> \u00d3O0000 = new ArrayList<voidsuper>();
    ...
    @Override
    public int o00000() {
        return 40 + (this.o00000 + this.\u00d3O0000.size()) * 10;
    }

    @Override
    public void o00000(Graphics graphics, int n, int n2, int n3) {
        Collections.sort(this.\u00d3O0000, public.o00000());
        this.o00000(graphics, n, n3, this.\u00d3O0000, _1.OO0000);
    }
}
